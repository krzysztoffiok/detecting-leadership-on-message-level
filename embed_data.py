...
parser.add_argument('--dependent_variable', required=False, type=str, default='leadership')
...
data = data[['text', dependent_variable, "id"]]

if binarize:
    data[dependent_variable] = data[dependent_variable].map(lambda x: _utils.binarize(x))
